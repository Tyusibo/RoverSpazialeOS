...
void MPU6050_Read_All(I2C_HandleTypeDef *I2Cx, MPU6050_t *DataStruct)
{
    ...
    // Calcolo asse Z (Yaw)
    // Nota: Senza magnetometro, non c'è un riferimento assoluto per lo Yaw da passare al filtro Kalman.
    // Si integra il giroscopio Z. Assicurati di inizializzare KalmanAngleZ a 0 nel tuo main.
