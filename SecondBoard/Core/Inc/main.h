...
#define SonarFront_Pin GPIO_PIN_10
#define SonarFront_GPIO_Port GPIOB
#define SonarRight_Pin GPIO_PIN_12
#define SonarRight_GPIO_Port GPIOB
#define SonarLeft_Pin GPIO_PIN_10
#define SonarLeft_GPIO_Port GPIOA
