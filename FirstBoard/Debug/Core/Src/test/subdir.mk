...
clean-Core-2f-Src-2f-test:
	-$(RM) ./Core/Src/test/communication_test.cyclo ./Core/Src/test/communication_test.d ./Core/Src/test/communication_test.o ./Core/Src/test/communication_test.su ./Core/Src/test/lights_test.cyclo ./Core/Src/test/lights_test.d ./Core/Src/test/lights_test.o ./Core/Src/test/lights_test.su ./Core/Src/test/motors_test.cyclo ./Core/Src/test/motors_test.d ./Core/Src/test/motors_test.o ./Core/Src/test/motors_test.su ./Core/Src/test/print.cyclo ./Core/Src/test/print.d ./Core/Src/test/print.o ./Core/Src/test/print.su
