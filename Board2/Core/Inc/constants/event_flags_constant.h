...
/* Controller / Pad */
#define FLAG_PAD_OK                 (1U << 2)
#define FLAG_PAD_ERROR              (1U << 3)

/* Gyroscope */
#define FLAG_GYRO_OK                (1U << 4)
#define FLAG_GYRO_ERROR             (1U << 5)

/* Sonar Left */
#define FLAG_SONAR_LEFT_OK          (1U << 6)
#define FLAG_SONAR_LEFT_TIMEOUT     (1U << 7)

/* Sonar Front */
#define FLAG_SONAR_FRONT_OK         (1U << 8)
#define FLAG_SONAR_FRONT_TIMEOUT    (1U << 9)

/* Sonar Right */
#define FLAG_SONAR_RIGHT_OK         (1U << 10)
#define FLAG_SONAR_RIGHT_TIMEOUT    (1U << 11)
