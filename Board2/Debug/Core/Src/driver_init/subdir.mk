...
clean-Core-2f-Src-2f-driver_init:
	-$(RM) ./Core/Src/driver_init/gyroscope_init.cyclo ./Core/Src/driver_init/gyroscope_init.d ./Core/Src/driver_init/gyroscope_init.o ./Core/Src/driver_init/gyroscope_init.su ./Core/Src/driver_init/motors_init.cyclo ./Core/Src/driver_init/motors_init.d ./Core/Src/driver_init/motors_init.o ./Core/Src/driver_init/motors_init.su ./Core/Src/driver_init/sonar_init.cyclo ./Core/Src/driver_init/sonar_init.d ./Core/Src/driver_init/sonar_init.o ./Core/Src/driver_init/sonar_init.su
